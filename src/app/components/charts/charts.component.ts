...
//         (data) => {
//           this.singleuserAllAttendances = data;
//           console.log('Fetched data:', this.singleuserAllAttendances);
...
//   updateChartData() {
//     const chartData = this.singleuserAllAttendances.map((attendance:any) => ({
//       date: new Date(attendance.attendanceDate), // Assuming 'attendanceDate' is in ISO string format
//       low: new Date(attendance.checkInTime).getTime(), // Convert to milliseconds
//       high: new Date(attendance.checkOutTime).getTime(), // Convert to milliseconds
//     }));
